...
print(
    aspirant
)  # Вывод: Аспирант: Smith John Doe, Группа: CS101, Средняя Оценка: 4.00, Научная Работа: Machine Learning, Прогресс: 50%
...
print(
    aspirant
)  # Вывод: Аспирант: Smith John Doe, Группа: CS101, Средняя Оценка: 4.00, Научная Работа: Machine Learning, Прогресс: 60%
