...
my_university.pay_scholarship()

# Посещение столовой студентом
student1 = my_university.students[0]
cafeteria1 = my_university.cafeterias[0]
student1.visit_cafeteria(cafeteria1, "Борщ")

# Посещение столовой аспирантом
aspirant1 = my_university.aspirants[0]
cafeteria2 = my_university.cafeterias[1]
